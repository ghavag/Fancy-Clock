...
PROJNAME=uhr2
SRC = main.cpp time.cpp lib/dcf77/DCF77.cpp lib/uart/uart.c lib/ds1302/ds1302.cpp DisplayDriver.cpp lib/light_ws2812/WS2812.cpp lib/light_ws2812/light_ws2812.cpp effects/BaseEffect.cpp effects/SimpleColor.cpp effects/RandomColoredDigit.cpp effects/FadingColors.cpp effects/FadingDigits.cpp effects/ColorExplosion.cpp effects/ColorExplosionRed.cpp effects/ColorExplosionGreen.cpp effects/ColorExplosionBlue.cpp
OFILE=$(PROJNAME).elf
