 ...
 * warned if you are a epileptic. This effect is a derivation of the
 * ColorExplosion effect with green beeing the dominant color.
 *
...
#ifndef COLOR_EXPLOSION_GREEN_H_
#define COLOR_EXPLOSION_GREEN_H_

#include "ColorExplosion.h"

class ColorExplosionGreen : public ColorExplosion {
public:
  /*
  * Class constructor
  *
  ...
  */
  ColorExplosionGreen(DisplayDriver *DD);

private:
  cRGB generateRandomColor();
};

#endif //COLOR_EXPLOSION_GREEN_H_
