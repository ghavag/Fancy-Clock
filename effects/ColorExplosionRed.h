...
#ifndef COLOR_EXPLOSION_RED_H_
#define COLOR_EXPLOSION_RED_H_

#include "ColorExplosion.h"

class ColorExplosionRed : public ColorExplosion {
public:
  /*
  * Class constructor
  *
  ...
  */
  ColorExplosionRed(DisplayDriver *DD);

private:
  cRGB generateRandomColor();
};

#endif //COLOR_EXPLOSION_RED_H_
